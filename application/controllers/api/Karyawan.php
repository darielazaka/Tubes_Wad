...
class karyawan extends REST_Controller {
    ...
    public function index_get()
    {
        ...
        $id = $this->get('ID');
        if($id === null){
            $data = $this->costeng->getCosteng('data_karyawan');
        }else{

            $data = $this->costeng->getCosteng('data_karyawan',$id,'ID');
        }
    ...
    public function index_delete(){
        ...
        if( $id === null){
            ...
            if( $this->costeng->deleteCosteng('data_karyawan',$id,'ID') > 0){
                $this->set_response([
                    'status' => true,
                    'data' => $id,
                    'message' => 'deleted'
    ...
    public function index_post(){
        ...
        if ($this->costeng->createCosteng('data_karyawan',$isi)> 0){
            $this->set_response([
                'status' => true,
    ...
    public function index_put(){
        ...
        if ($this->costeng->updateCosteng('data_karyawan',$isi,$id,'ID')> 0){
            $this->set_response([
                'status21' => $id,
                'status' => true,
