              ...
              <form action="<?php echo base_url(). 'Karyawan/update'; ?>" method="post">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Masukkan NIP" name="data3" value="<?php echo $u->NIP ?>">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Nama Teknisi" name="data4" value="<?php echo $u->Alamat ?>">
                  </div>

                                    <div class="form-group">
                    <label for="exampleInputEmail1">No_telp</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Nama Teknisi" name="data5" value="<?php echo $u->No_telp ?>">
                  </div>
