              ...
              <form action="<?php echo base_url(). 'Operasional/update'; ?>" method="post">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Nama Penanggung Jawab" name="data4" value="<?php echo $u->PJ ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Indikasi</label>
                    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Status Terakhir" name="data5" value="<?php echo $u->Indikasi ?>">
                  </div>
