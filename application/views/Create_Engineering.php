  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      ...
      <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?php echo base_url(). 'Engineering/tambah_aksi'; ?>" method="post">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Masukkan Biaya" name="data2">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Nama Teknisi</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Nama Teknisi" name="data3">
                  </div>
                  <div class="form-group">
