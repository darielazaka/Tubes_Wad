  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      ...
      <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?php echo base_url(). 'Finance/tambah_aksi'; ?>" method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Nama Issues</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Nama Issues" name="data1">
                  </div>
                      <div class="form-group">
                        <label>Divisi</label>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Biaya" name="data3">
                  </div>
                  <div class="form-group">
