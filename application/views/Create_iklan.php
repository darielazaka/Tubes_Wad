  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      ...
      <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?php echo base_url(). 'Marketing/tambah_aksi'; ?>" method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Tujuan Iklan</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Tujuan iklan" name="data1">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Platform</label>
                    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Masukkan Platform" name="data2">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Periode</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Periode iklan" name="data3">
                  </div>
                  <div class="form-group">
